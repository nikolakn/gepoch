...
public:	    
    ...
    double GetJD()     {return m_jdate;};
    int GetGregDay()   {return m_day;};
    int GetGregMonth() {return m_month;};
    int GetGregYear() {return m_year;};
    short GetMin()     {return m_iminute;};
    short GetHour()    {return m_ihour;};
    double GetSec()     {return m_second;};
    short GetWeekDay() {return m_weekday;};
    int GetWeekDaySt() {
        return m_weekday;
    }	       
...
private:
    ...
    int gregoriano_jd(){
        ...
        return calo_jd(era,godina,m_month,m_day,m_ihour,m_iminute,m_second );
    ...
    void jdo_gregorian(){
            ...
            m_weekday = (short)floor( (t/7.0 - floor(t/7.0))*7.0 + 0.000000000317 );  
...
public:
    ...
    //			if( y < 0 )  ++y;
        ...
        double intgr = floor( floor(365.25*jy) + floor(30.6001*jm) + d + 1720995 );
    ...
    endelse:;
       ...
       god=deo;
            rez.SetLongDate((dan).toInt(),(mesec).toInt(),(god).toInt(),rez.GetHour(),rez.GetMin());
    ...
    endelse:;
      ...
      QString hh;
            ...
            if((min).toInt()<0 || (min).toInt()>60){
             ...
             vreme.SetLongDate(rez.GetGregDay(),rez.GetGregMonth(),rez.GetGregYear(),(sat).toInt(),(min).toInt());
             rez=vreme;
       return true;
    }
